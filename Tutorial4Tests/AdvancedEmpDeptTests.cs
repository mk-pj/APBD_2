...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = (from e in emps where e.Mgr is not null select e).ToList();
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        // var result = (from e in emps select e).All(e => e.Sal > 500);
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = (from e in emps where e.Comm is not null select e).Any(e => e.Comm > 400);
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = (from e in emps
            join emp in emps on e.Mgr equals emp.EmpNo
            select new { Employee = e.EName, Manager = emp.EName });

        // var result = emps.Join(emps, e => e.Mgr, e => e.EmpNo,
        //     (e, emp) => new { Employee = e.EName, Manager = emp.EName });
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            ...
            .SelectMany(e => grades.Where(g => e.Sal >= g.Losal && e.Sal <= g.Hisal),
                (e, g) => new { e.EName, e.DName, g.Grade });
